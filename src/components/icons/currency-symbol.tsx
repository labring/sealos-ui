...
export type CurrencyType = 'shellCoin' | 'cny' | 'usd';

export interface CurrencySymbolProps extends React.HTMLAttributes<HTMLSpanElement> {
  shellCoin?: React.SVGProps<SVGSVGElement>;
  type?: CurrencyType;
}

export function CurrencySymbol({ type = 'shellCoin', shellCoin, ...props }: CurrencySymbolProps) {
  if (type === 'cny') {
